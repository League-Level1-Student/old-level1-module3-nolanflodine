...
JLabel label1 = new JLabel();
	private void createBook() {
		...
		String dress= "/extra/Dress.png";
		String Jesus= "/extra/Jesus.jpg";
		// 6. create a variable of type "JLabel" but don’t initialize it yet
		
		// 7. use the "loadImage..." methods below to initialize your JLabel
		label1=loadImageFromComputer("Illusion.jpg");
	...
	public void mousePressed(MouseEvent e) {
		...
		label2=loadImageFromComputer("Dress.png");
		frame.add(label2);
		frame.pack();
		JOptionPane.showMessageDialog(null, "It's yellow and white!");
